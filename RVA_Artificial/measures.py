...
class sim():
    ...
    def cosineMatrix(ph, words): #takes in model and list of words
    ...
    #is this just the cosine between two individual words? or a word and all other words?
#    def singleCosine(ph,words,target): #must put both words in list, ie ['the']
...
class vis():
    #what does this graph do/show?
    def mdsPlot(ph, words): #what does mds stand for? multidimensional scaling?
